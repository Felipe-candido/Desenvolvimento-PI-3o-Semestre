...
from . import views
from .views import  realizar_login, logout, add_usuario2, perfil, editar_usuario, index, excluir_projeto, editar_projeto, ver_projeto, adicionar_comentario, sobre, categoria
